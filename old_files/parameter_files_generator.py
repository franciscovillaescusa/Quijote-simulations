...
for cosmo in ['fiducial_ZA']:#cosmologies:
    
    # fidn the number of realizations for each model
    if   cosmo=='fiducial_LR':  derivatives_realizations = 1000
    elif cosmo=='fiducial_HR':  derivatives_realizations = 100
    elif cosmo=='fiducial_ZA':  derivatives_realizations = 500
    else:                       derivatives_realizations = 500

    # find the example parameter file
    if   cosmo=='Mnu_p':   fiducial_file = 'N-GenIC_0.10.param'
    elif cosmo=='Mnu_pp':  fiducial_file = 'N-GenIC_0.20.param'
    elif cosmo=='Mnu_ppp': fiducial_file = 'N-GenIC_0.40.param'
