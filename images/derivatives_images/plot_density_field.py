...
for cosmo in ['Om','Ob2','h','ns','s8','Mnu']:
    
    for suffix in ['p','m']:

        if cosmo=='Mnu' and suffix=='m':
            suffix='pp'

        print cosmo,suffix
        snapshot_fname = '/simons/scratch/fvillaescusa/pdf_information/%s_%s/0/snapdir_004/snap_004'%(cosmo,suffix)
